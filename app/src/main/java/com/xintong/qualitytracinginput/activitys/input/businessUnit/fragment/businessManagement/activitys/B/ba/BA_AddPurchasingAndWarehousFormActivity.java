package com.xintong.qualitytracinginput.activitys.input.businessUnit.fragment.businessManagement.activitys.B.ba;
...
//新增采购入库
public class BA_AddPurchasingAndWarehousFormActivity extends Activity{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ba_add_purchasing_and_warehous_form_activity);
        AnnotateUtil.inject(this);
        context=BA_AddPurchasingAndWarehousFormActivity.this;
        initView();
    }

    private void initView() {
        webView.getSettings().setJavaScriptEnabled(true);
        String url= ConstNumbers.Urls.ip_address+"login/app/appClient3/BA_PurchasingAndWarehousController/getBA_AddPurchasingAndWarehousForm";//新增供应商基本信息,获取表单
