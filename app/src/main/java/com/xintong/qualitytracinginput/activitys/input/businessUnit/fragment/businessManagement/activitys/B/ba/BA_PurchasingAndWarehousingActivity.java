...
//采购入库列表
public class BA_PurchasingAndWarehousingActivity extends Activity{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ba_purchasing_and_warehousing_activity);
        AnnotateUtil.inject(this);
        context=BA_PurchasingAndWarehousingActivity.this;
        initView();
    }
