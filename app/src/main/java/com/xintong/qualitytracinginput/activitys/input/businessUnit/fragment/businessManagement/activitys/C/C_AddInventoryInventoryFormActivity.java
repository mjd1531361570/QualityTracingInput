...
//新增库存盘点
public class C_AddInventoryInventoryFormActivity extends Activity{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.c_add_inventory_inventory_form_activity);
        AnnotateUtil.inject(this);
        context= C_AddInventoryInventoryFormActivity.this;
        initView();
    }

    private void initView() {
        webView.getSettings().setJavaScriptEnabled(true);
        String url= ConstNumbers.Urls.ip_address+"login/app/appClient3/C_AddInventoryInventoryFormController/getC_AddInventoryInventoryForm";//新增库存盘点,获取表单
