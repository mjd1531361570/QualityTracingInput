...
//新增退货表单
public class BC_AddPurchaseOfReturnFormActivity extends Activity{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bc_add_purchase_of_return_form_activity);
        AnnotateUtil.inject(this);
        context= BC_AddPurchaseOfReturnFormActivity.this;
        initView();
    }

    private void initView() {
        webView.getSettings().setJavaScriptEnabled(true);
        String url= ConstNumbers.Urls.ip_address+"login/app/appClient3/BC_AddPurchaseOfReturnController/getAddPurchaseOfReturnForm";//新增退货表单,获取表单
