package com.xintong.qualitytracinginput.activitys.input.businessUnit.fragment.businessManagement.activitys.D.dc;
...
//新增DC销售退货
public class DC_AddSalesReturnFormActivity extends Activity{
    Context context;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dc_add_sales_return_form_activity);
        AnnotateUtil.inject(this);
        context= DC_AddSalesReturnFormActivity.this;
        initView();
    }

    private void initView() {
        webView.getSettings().setJavaScriptEnabled(true);
        String url= ConstNumbers.Urls.ip_address+"login/app/appClient3/DC_AddSalesReturnFormController/getAddDC_AddSalesReturnForm";//新增供应商基本信息,获取表单
